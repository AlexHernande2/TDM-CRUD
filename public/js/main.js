...
// Envío del form
// creación del item con los metodos traidos de api
form.addEventListener("submit", async (e) => {
    ...
    try {
        if (editingId) {
            await updateItem(editingId, { name, description, precio, categoria, marca, stock});
            editingId = null;
        } else {
            await createItem({ name, description, precio, categoria, marca, stock});
        }
